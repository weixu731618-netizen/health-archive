...
class HelpPage extends StatelessWidget {
  ...
  static const _articles = <(String, String)>[
    ...
    (
      '多页报告 / 体检报告怎么传',
      '体检报告、出院小结这类有好几页的，最省事的方式是「整份拼成一个 PDF，一次上传」。'
          'App 会逐页识别再合并成一份记录，原件也完整保留。\n\n'
          '公司体检机构给的报告一般本来就是 PDF：上传时选「文件」，直接选那个 PDF。\n\n'
          '社康 / 医院给的是纸质的：用手机自带的「扫描」功能（相机或备忘录里都有），'
          '把每一页扫进去、拼成一个 PDF，再上传。\n\n'
          '「拍报告」目前一次只能拍一页，多页的别用它逐页拍。',
    ),
    (
      '识别得不对怎么办',
